...
<head>
  ...
  <title>[관리자]질문게시판 : 흥해지역아동센터</title>
  ...
  <header id="header">
    <div class="container">
      ...
      <nav id="nav-menu-container">
        <ul class="nav-menu">
          <li><a href="../../manage/list">공지게시판</a></li>
	...
	<section id="notice">
		<div class="container">
		  <div class="content">
			...
			<h3><i class="fas fa-chevron-left mr-3" onclick="history.back()"></i>답변 수정</h3>
			<form action="../editok" method="post">
				<input type="hidden" name="id" value="${a.id}">
				<div class="form-group">
					<label for="content">내용</label>
					<textarea class="form-control" name="content" rows="5">${a.content}</textarea>
				</div>
