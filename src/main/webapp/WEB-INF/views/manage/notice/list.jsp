	...
	<section id="notice">
		<div class="container">
		  <div class="content">
			...
			<div class="float-right mb-2"><a href="write" class="btn btn-primary">공지 등록하기</a></div>
				...
				<tbody>
					<c:forEach items="${list}" var="u">
						<tr>
							...
							<td><a href="edit/${u.id}" class="btn btn-sm btn-secondary">수정</a></td>
							<td><a href="javascript:delete_ok('${u.id}')" class="btn btn-sm btn-danger">삭제</a></td>
						</tr>
					</c:forEach>
				</tbody>
			</table>
